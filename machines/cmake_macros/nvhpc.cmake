...
if (GPU_TYPE STREQUAL h100 AND GPU_OFFLOAD STREQUAL openmp)
   string(APPEND GPUFLAGS  " -mp=gpu -gpu=ccnative,lineinfo,nofma -Minfo=accel ")
endif()
if (GPU_TYPE STREQUAL h100 AND GPU_OFFLOAD STREQUAL combined)
   string(APPEND GPUFLAGS  " -acc -gpu=ccnative,lineinfo,nofma -mp=gpu -Minfo=accel")
endif()
if (MPILIB STREQUAL mpi-serial)
  string(APPEND SLIBS " -ldl")
endif()
# EarthWorks specific: add this flag ONLY for GPU runs which tend to use high pcols values
if (GPU_OFFLOAD STREQUAL openacc)
